...
<h2>Agent's Phone - LIS Subscription Status</h2>
...
String classId = (String)params.get("class_id");
if (classId == null){
	classId = ""; // should never be NULL
}
...
<%
					...
					if (classIdStatusList != null){
						for (ClassIDStatusResponseBean classIdStatusObj : classIdStatusList) {
							...
							if (classId.equalsIgnoreCase(classIdReturned)){
%>								
